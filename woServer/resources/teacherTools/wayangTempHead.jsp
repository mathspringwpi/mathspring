                                    ...
                                    <li><a href="#">Edit Classes/Topics</a>
                                        <div>
                                            <ul>
                                                ...
                                                <li><a href="<c:out value="${pageContext.request.contextPath}"/>/WoAdmin?action=AdminAlterClassPedagogies&teacherId=<c:out value="${teacherId}"/>&classId=<c:out value="${classId}"/>">Tutoring Strategy Selection</a></li>
